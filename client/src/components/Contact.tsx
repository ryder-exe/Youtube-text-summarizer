    ...
    const fetchGithubInfo = async () => {
      try {
        const response = await axios.get<GitHubInfo>(
          "https://api.github.com/users/ryder-exe"
        );
      ...
      <div className="contactmain">
        <div className="innerbox">
          ...
          <div className="lowertext">
            ...
            <h2>
              {githubInfo && (
                <Link to="https://github.com/ryder-exe" className="link">
                  <FaGithub />
                </Link>
              )}
            </h2>
            <div className="cardholder">
              <div className="card">
                {githubInfo && (
                  <h5>Repositories : {githubInfo.public_repos}</h5>
                )}
              </div>
              <div className="card">
                {githubInfo && (
                  <Link
                    to="https://www.linkedin.com/in/faiz-khan101/"
                    className="link"
                  >
                    <FaLinkedin />
                  </Link>
